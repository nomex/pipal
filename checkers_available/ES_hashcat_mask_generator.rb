#coding: ISO-8859-1
register_checker("ES_Hashcat_Mask_Generator")

class ES_Hashcat_Mask_Generator < Checker

	def initialize
		super
		@description = "Generador de mascaras para Hashcat"
		@hashcat_masks = {}
	end
	...
	def get_results()
		ret_str = "Mascaras para Hashcat (Top #{@cap_at.to_s})\n\n"
